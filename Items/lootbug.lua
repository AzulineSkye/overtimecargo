local sprite_mask = Resources.sprite_load(NAMESPACE, "lootbugMask", path.combine(PATH, "Sprites/fx/lootbugMask.png"), 1, 15, 11)
local sprite_idle = Resources.sprite_load(NAMESPACE, "lootbugIdle", path.combine(PATH, "Sprites/fx/lootbugIdle.png"), 1, 15, 11)
local sprite_walk = Resources.sprite_load(NAMESPACE, "lootbugWalk", path.combine(PATH, "Sprites/fx/lootbugWalk.png"), 8, 15, 11)
local sprite_run = Resources.sprite_load(NAMESPACE, "lootbugRun", path.combine(PATH, "Sprites/fx/lootbugRun.png"), 8, 15, 11)
local sprite_spawn = Resources.sprite_load(NAMESPACE, "lootbugSpawn", path.combine(PATH, "Sprites/fx/lootbugSpawn.png"), 14, 24, 20)
local sprite_burrow = Resources.sprite_load(NAMESPACE, "lootbugBurrow", path.combine(PATH, "Sprites/fx/lootbugBurrow.png"), 15, 24, 20)
local sprite_death = Resources.sprite_load(NAMESPACE, "lootbugDeath", path.combine(PATH, "Sprites/fx/lootbugDeath.png"), 12, 20, 21)
