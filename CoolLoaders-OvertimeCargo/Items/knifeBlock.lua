...
block:set_loot_tags(Item.LOOT_TAG.category_damage, Item.LOOT_TAG.equipment_blacklist_chaos, Item.LOOT_TAG.equipment_blacklist_activator, Item.LOOT_TAG.equipment_blacklist_enigma)
